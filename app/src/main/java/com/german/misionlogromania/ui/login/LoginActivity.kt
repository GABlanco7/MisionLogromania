...
import com.german.misionlogromania.ui.profile.CreateChildProfileActivity
...
import com.german.misionlogromania.ui.register.RegisterActivity
    ...
    private fun checkFirstTimeAndRedirect() {
        ...
        db.collection("users").document(userId).get()
            .addOnSuccessListener { doc ->
                if (!doc.exists()) {
                    navigateTo(PadreMenuActivity::class.java)
